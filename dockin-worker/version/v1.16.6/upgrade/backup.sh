...
#==============================================================================
#description     :upgrade kubernetes cluster to 1.13.12.
#author		     :
#linux           :centos7
#user            :root
...
log INFO "backup /var/lib/kubelet/config.yaml..."
mkdir -p /data/kubernetes/backup/$backuptime/var/lib/kubelet
cp -r /var/lib/kubelet/config.yaml /data/kubernetes/backup/$backuptime/var/lib/kubelet


log INFO "backup cni plugins..."
mkdir -p /data/kubernetes/backup/$backuptime/cni
cp -r /etc/cni/net.d/* /data/kubernetes/backup/$backuptime/cni
...
cp -r $current_dir/restore.sh /data/kubernetes/backup/$backuptime/
